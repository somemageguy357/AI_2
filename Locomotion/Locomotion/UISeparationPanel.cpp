...
CUISeparationPanel::CUISeparationPanel(sf::Vector2f _v2fTopLeftPosition)
{
	...
	m_poSeparationText = CreateText(20, { fX + 10, fY + 10 }, "Separation", sf::Color::White, EAlignment::TopLeft, true);
	...
	m_poDecNeighbourhoodRadiusBtn = CreateButton({ 30, 20 }, { fX + 10, fY + 145 }, CUIButton::EButtonType::DecSeparationNHR, EAlignment::TopLeft, 14, "-1", true);
	m_poIncNeighbourhoodRadiusBtn = CreateButton({ 30, 20 }, { fX + 50, fY + 145 }, CUIButton::EButtonType::IncSeparationNHR, EAlignment::TopLeft, 14, "+1", true);
