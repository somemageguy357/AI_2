...
CUIArrivalPanel::CUIArrivalPanel(sf::Vector2f _v2fTopLeftPosition)
{
	...
	m_poStoppingRadiusText = CreateText(14, { fX + 90, fY + 145 }, "Stopping Radius: 100", sf::Color::White, EAlignment::TopLeft, m_bEnabled);
	...
	m_poDecrementStrengthBtn = CreateButton({ 30, 20 }, { fX + 10, fY + 75 }, CUIButton::EButtonType::DecArrivalStrength, EAlignment::TopLeft, 14, "-1", m_bEnabled);
	m_poIncrementStrengthBtn = CreateButton({ 30, 20 }, { fX + 50, fY + 75 }, CUIButton::EButtonType::IncArrivalStrength, EAlignment::TopLeft, 14, "+1", m_bEnabled);
	m_poDecrementMaxSteerForceBtn = CreateButton({ 30, 20 }, { fX + 10, fY + 110 }, CUIButton::EButtonType::DecArrivalMSF, EAlignment::TopLeft, 14, "-1", m_bEnabled);
	m_poIncrementMaxSteerForceBtn = CreateButton({ 30, 20 }, { fX + 50, fY + 110 }, CUIButton::EButtonType::IncArrivalMSF, EAlignment::TopLeft, 14, "+1", m_bEnabled);
	m_poDecrementStoppingRadiusBtn = CreateButton({ 30, 20 }, { fX + 10, fY + 145 }, CUIButton::EButtonType::DecArrivalStoppingRadius, EAlignment::TopLeft, 14, "-5", m_bEnabled);
	m_poIncrementStoppingRadiusBtn = CreateButton({ 30, 20 }, { fX + 50, fY + 145 }, CUIButton::EButtonType::IncArrivalStoppingRadius, EAlignment::TopLeft, 14, "+5", m_bEnabled);
}
